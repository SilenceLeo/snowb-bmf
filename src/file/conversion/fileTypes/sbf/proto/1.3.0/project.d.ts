...
export interface IStyle {
  ...
  useInnerShadow?: boolean | null

  /** Style innerShadow */
  innerShadow?: IShadow | null
}
...
export class Style implements IStyle {
  ...
  /** Style useInnerShadow. */
  public useInnerShadow: boolean

  /** Style innerShadow. */
  public innerShadow?: IShadow | null
...
export class Extensions implements IExtensions {
   ...
   * @param [properties] Properties to set
   */
  constructor(properties?: IExtensions)
   ...
   * @param [properties] Properties to set
   * @returns Extensions instance
   */
  public static create(properties?: IExtensions): Extensions

  /**
   * Encodes the specified Extensions message. Does not implicitly {@link Extensions.verify|verify} messages.
   * @param message Extensions message or plain object to encode
   * @param [writer] Writer to encode to
   * @returns Writer
   */
  public static encode(
...
export class Project implements IProject {
  ...
  /** Project extensions. */
  public extensions?: IExtensions | null
