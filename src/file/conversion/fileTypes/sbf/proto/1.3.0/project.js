...
export const GradientColor = ($root.GradientColor = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  GradientColor.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const Gradient = ($root.Gradient = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  Gradient.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const PatternTexture = ($root.PatternTexture = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  PatternTexture.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const Fill = ($root.Fill = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  Fill.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const FontResource = ($root.FontResource = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  FontResource.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const GlyphFont = ($root.GlyphFont = (() => {
   ...
   * @property {number|null} [page] GlyphFont page
   */
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  GlyphFont.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const GlyphImage = ($root.GlyphImage = (() => {
   ...
   * @property {number|null} [page] GlyphImage page
   */
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  GlyphImage.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
...
export const Style = ($root.Style = (() => {
   ...
   * @property {boolean|null} [useInnerShadow] Style useInnerShadow
   * @property {IShadow|null} [innerShadow] Style innerShadow
   */
  ...
  /**
   * Style useInnerShadow.
   * @member {boolean} useInnerShadow
   * @memberof Style
   * @instance
   */
  Style.prototype.useInnerShadow = false

  /**
   * Style innerShadow.
   * @member {IShadow|null|undefined} innerShadow
   * @memberof Style
   * @instance
   */
  Style.prototype.innerShadow = null
  ...
  Style.encode = function encode(message, writer) {
    ...
    if (
      message.useInnerShadow != null &&
      Object.hasOwnProperty.call(message, 'useInnerShadow')
    )
      writer.uint32(/* id 9, wireType 0 =*/ 72).bool(message.useInnerShadow)
    if (
      message.innerShadow != null &&
      Object.hasOwnProperty.call(message, 'innerShadow')
    )
      $root.Shadow.encode(
        message.innerShadow,
  ...
  Style.decode = function decode(reader, length, error) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          message.useInnerShadow = reader.bool()
          break
        }
        case 10: {
          message.innerShadow = $root.Shadow.decode(reader, reader.uint32())
          break
        }
        default:
          reader.skipType(tag & 7)
  ...
  Style.verify = function verify(message) {
    ...
    if (
      message.useInnerShadow != null &&
      message.hasOwnProperty('useInnerShadow')
    )
      if (typeof message.useInnerShadow !== 'boolean')
        return 'useInnerShadow: boolean expected'
    if (message.innerShadow != null && message.hasOwnProperty('innerShadow')) {
      let error = $root.Shadow.verify(message.innerShadow)
      if (error) return 'innerShadow.' + error
    }
    return null
  }
  ...
  Style.fromObject = function fromObject(object) {
    ...
    if (object.useInnerShadow != null)
      message.useInnerShadow = Boolean(object.useInnerShadow)
    if (object.innerShadow != null) {
      if (typeof object.innerShadow !== 'object')
        throw TypeError('.Style.innerShadow: object expected')
      message.innerShadow = $root.Shadow.fromObject(object.innerShadow)
    }
    return message
  }
  ...
  Style.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      ...
      object.bgColor = ''
      object.render = null
      object.useInnerShadow = false
      object.innerShadow = null
    }
    if (message.font != null && message.hasOwnProperty('font'))
    ...
    if (
      ...
      object.useInnerShadow = message.useInnerShadow
    if (message.innerShadow != null && message.hasOwnProperty('innerShadow'))
      object.innerShadow = $root.Shadow.toObject(message.innerShadow, options)
    return object
  }
...
export const Ui = ($root.Ui = (() => {
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  Ui.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.Ui()
    while (reader.pos < end) {
...
export const Extensions = ($root.Extensions = (() => {
  /**
   * Properties of an Extensions.
   * @exports IExtensions
   * @interface IExtensions
   * @property {number|null} [xFractional] Extensions xFractional
   */

  /**
   * Constructs a new Extensions.
   * @exports Extensions
   * @classdesc Represents an Extensions.
   * @implements IExtensions
   * @constructor
   * @param {IExtensions=} [properties] Properties to set
   */
  function Extensions(properties) {
    if (properties)
      for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
        if (properties[keys[i]] != null) this[keys[i]] = properties[keys[i]]
  }
  ...
  /**
   * Extensions xFractional.
   * @member {number} xFractional
   * @memberof Extensions
   * @instance
   */
  Extensions.prototype.xFractional = 0

  /**
   * Creates a new Extensions instance using the specified properties.
   * @function create
   * @memberof Extensions
   * @static
   * @param {IExtensions=} [properties] Properties to set
   * @returns {Extensions} Extensions instance
   */
  Extensions.create = function create(properties) {
    return new Extensions(properties)
  }

  /**
   * Encodes the specified Extensions message. Does not implicitly {@link Extensions.verify|verify} messages.
   * @function encode
   * @memberof Extensions
   * @static
   * @param {IExtensions} message Extensions message or plain object to encode
   * @param {$protobuf.Writer} [writer] Writer to encode to
   * @returns {$protobuf.Writer} Writer
   */
  Extensions.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create()
    if (
      message.xFractional != null &&
      Object.hasOwnProperty.call(message, 'xFractional')
    )
      writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.xFractional)
    return writer
  }

  /**
   * Encodes the specified Extensions message, length delimited. Does not implicitly {@link Extensions.verify|verify} messages.
   * @function encodeDelimited
   * @memberof Extensions
   * @static
   * @param {IExtensions} message Extensions message or plain object to encode
   ...
   * @returns {$protobuf.Writer} Writer
   */
  Extensions.encodeDelimited = function encodeDelimited(message, writer) {
    return this.encode(message, writer).ldelim()
  }

  /**
   * Decodes an Extensions message from the specified reader or buffer.
   * @function decode
   * @memberof Extensions
   * @static
   * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  Extensions.decode = function decode(reader, length, error) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.Extensions()
    while (reader.pos < end) {
      let tag = reader.uint32()
      if (tag === error) break
      switch (tag >>> 3) {
        case 1: {
          message.xFractional = reader.int32()
          break
        }
        default:
          reader.skipType(tag & 7)
  ...
  /**
   * Decodes an Extensions message from the specified reader or buffer, length delimited.
   * @function decodeDelimited
   * @memberof Extensions
   * @static
   * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  Extensions.decodeDelimited = function decodeDelimited(reader) {
    if (!(reader instanceof $Reader)) reader = new $Reader(reader)
    return this.decode(reader, reader.uint32())
  }

  /**
   * Verifies an Extensions message.
   * @function verify
   * @memberof Extensions
   * @static
   * @param {Object.<string,*>} message Plain object to verify
   * @returns {string|null} `null` if valid, otherwise the reason why it is not
   */
  Extensions.verify = function verify(message) {
    if (typeof message !== 'object' || message === null)
      return 'object expected'
    if (message.xFractional != null && message.hasOwnProperty('xFractional'))
      if (!$util.isInteger(message.xFractional))
        return 'xFractional: integer expected'
    return null
  }

  /**
   * Creates an Extensions message from a plain object. Also converts values to their respective internal types.
   * @function fromObject
   * @memberof Extensions
   * @static
   * @param {Object.<string,*>} object Plain object
   * @returns {Extensions} Extensions
   */
  Extensions.fromObject = function fromObject(object) {
    if (object instanceof $root.Extensions) return object
    let message = new $root.Extensions()
    if (object.xFractional != null) message.xFractional = object.xFractional | 0
    return message
  }

  /**
   * Creates a plain object from an Extensions message. Also converts values to other types if specified.
   * @function toObject
   * @memberof Extensions
   * @static
   ...
   * @returns {Object.<string,*>} Plain object
   */
  Extensions.toObject = function toObject(message, options) {
    if (!options) options = {}
    let object = {}
    if (options.defaults) object.xFractional = 0
    if (message.xFractional != null && message.hasOwnProperty('xFractional'))
      object.xFractional = message.xFractional
    return object
  }

  /**
   * Converts this Extensions to JSON.
   * @function toJSON
   * @memberof Extensions
   * @instance
   * @returns {Object.<string,*>} JSON object
  ...
  /**
   * Gets the default type url for Extensions
   * @function getTypeUrl
   * @memberof Extensions
   * @static
   * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
   * @returns {string} The default type url
   */
  Extensions.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
    if (typeUrlPrefix === undefined) {
      typeUrlPrefix = 'type.googleapis.com'
    }
    return typeUrlPrefix + '/Extensions'
  }
...
export const Project = ($root.Project = (() => {
   ...
   * @property {IExtensions|null} [extensions] Project extensions
   */
  ...
  /**
   * Project extensions.
   * @member {IExtensions|null|undefined} extensions
   * @memberof Project
   * @instance
   */
  Project.prototype.extensions = null
  ...
  Project.decode = function decode(reader, length, error) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          message.extensions = $root.Extensions.decode(reader, reader.uint32())
          break
        }
        default:
          reader.skipType(tag & 7)
  ...
  Project.verify = function verify(message) {
    ...
    if (message.extensions != null && message.hasOwnProperty('extensions')) {
      let error = $root.Extensions.verify(message.extensions)
  ...
  Project.fromObject = function fromObject(object) {
    ...
    if (object.extensions != null) {
      if (typeof object.extensions !== 'object')
        throw TypeError('.Project.extensions: object expected')
      message.extensions = $root.Extensions.fromObject(object.extensions)
    }
    return message
  }
  ...
  Project.toObject = function toObject(message, options) {
    ...
    if (message.extensions != null && message.hasOwnProperty('extensions'))
      object.extensions = $root.Extensions.toObject(message.extensions, options)
    return object
  }
