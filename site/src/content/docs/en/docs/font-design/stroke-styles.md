...
- **Width**: Outline thickness in pixels. Thicker strokes carry more visual weight but can obscure details on small fonts.
...
### Line Caps and Joins
These settings control corners and line endings — especially important for stylized or script fonts.
...
The stroke itself supports the same fill options as the font body:
...
- Ensure high contrast between the stroke and the font's main fill for readability.
